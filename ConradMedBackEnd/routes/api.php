...
use App\Http\Controllers\OrdenDocumentoController;
use App\Http\Controllers\WhatsappConversacionController;
...
Route::get('/wasapi/numeros', [WasapiController::class, 'obtenerNumeros']);
Route::post('/ordenes/{order_id}/documento', [OrdenDocumentoController::class, 'guardarDocumento']);
Route::post('/ordenes/{order_id}/enviar/whatsapp-texto', [WhatsappController::class, 'enviarTexto']);
Route::post('/whatsapp/status-or-template', [WhatsappController::class, 'checarStatusYEnviarSiFailed']);
Route::post('/whatsapp/consultar-status', [WhatsappController::class, 'consultarStatusFinal']);
